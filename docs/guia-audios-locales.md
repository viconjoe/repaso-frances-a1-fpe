...
La versión 1.3 mantiene la UX móvil refinada y no cambia este criterio: los audios locales serían archivos estáticos del autor, no grabaciones del alumnado. La estructura `assets/lang/` permite documentar nombres de audio previstos para futuras variantes de idioma.
