# Ficha pedagógica · Repaso Final Francés A1
...
Este recurso es una propuesta pedagógica digital complementaria para repasar contenidos básicos de Francés A1.

No es un curso completo.  
...
Al finalizar el uso del recurso, el alumnado debería ser capaz de:
...
- baja carga técnica;
- generación opcional de una evidencia local de práctica.
...
El recurso puede usarse al final del curso para reforzar contenidos y detectar inseguridades.

### Uso como evidencia de práctica

El alumnado puede preparar un informe local con su progreso orientativo y su producción breve, siempre recordando que no es una evaluación oficial.

### Uso como evidencia de portfolio
...
- etiquetas de idioma en frases francesas;
- actividades breves y segmentadas;
- instrucciones simples;
- vista de informe con formato limpio e imprimible.
...
El informe de práctica se genera localmente en el navegador. No se envía información a ningún servidor ni a servicios externos.
...
- JavaScript vanilla.
- `localStorage`.
- Web Speech API como apoyo experimental de pronunciación.
- API nativa de impresión del navegador para guardar el informe como PDF.
