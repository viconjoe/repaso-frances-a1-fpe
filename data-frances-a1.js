...
var EIJ_FLASHCARDS = [
      { fr: "Bonjour", es: "Buenos días / Hola", hint: "Saludo básico durante el día", audio: "bonjour.m4a" },
      { fr: "Bonsoir", es: "Buenas noches / Buenas tardes (tarde-noche)", hint: "Saludo al final del día, desde el atardecer", audio: "bonsoir.m4a" },
      { fr: "Au revoir", es: "Adiós / Hasta luego", hint: "Despedida", audio: "au-revoir.m4a" },
      { fr: "Merci beaucoup", es: "Muchas gracias", hint: "Agradecimiento", audio: "merci-beaucoup.m4a" },
      { fr: "Excusez-moi", es: "Disculpe / Perdón", hint: "Cortesía para llamar la atención", audio: "excusez-moi.m4a" },
      { fr: "Je m'appelle…", es: "Me llamo…", hint: "Presentación", audio: "je-mappelle.m4a" },
      { fr: "J'habite à…", es: "Vivo en…", hint: "Lugar de residencia", audio: "jhabite-a.m4a" },
      { fr: "Je suis espagnol(e)", es: "Soy español/a", hint: "Nacionalidad", audio: "je-suis-espagnol.m4a" },
      { fr: "Je suis étudiant(e)", es: "Soy estudiante", hint: "Situación personal", audio: "je-suis-etudiant.m4a" },
      { fr: "Je travaille", es: "Trabajo", hint: "Actividad laboral", audio: "je-travaille.m4a" },
      { fr: "Je cherche du travail", es: "Busco trabajo", hint: "Empleo", audio: "je-cherche-du-travail.m4a" },
      { fr: "Je voudrais…", es: "Quisiera…", hint: "Petición educada", audio: "je-voudrais.m4a" },
      { fr: "Combien ça coûte ?", es: "¿Cuánto cuesta?", hint: "Compra básica", audio: "combien-ca-coute.m4a" },
      { fr: "L'addition, s'il vous plaît", es: "La cuenta, por favor", hint: "Restaurante", audio: "addition-sil-vous-plait.m4a" },
      { fr: "Où est la gare ?", es: "¿Dónde está la estación?", hint: "Ciudad y transporte", audio: "ou-est-la-gare.m4a" },
      { fr: "À gauche", es: "A la izquierda", hint: "Direcciones", audio: "a-gauche.m4a" },
      { fr: "À droite", es: "A la derecha", hint: "Direcciones", audio: "a-droite.m4a" },
      { fr: "Je vais prendre le bus", es: "Voy a coger el bus", hint: "Transporte y futuro próximo", audio: "je-vais-prendre-le-bus.m4a" },
      { fr: "J'ai rendez-vous", es: "Tengo una cita", hint: "Cita o gestión", audio: "jai-rendez-vous.m4a" },
      { fr: "Il est neuf heures", es: "Son las nueve", hint: "Hora", audio: "il-est-neuf-heures.m4a" },
      { fr: "Aujourd'hui", es: "Hoy", hint: "Tiempo", audio: "aujourdhui.m4a" },
      { fr: "Demain", es: "Mañana", hint: "Tiempo", audio: "demain.m4a" },
      { fr: "Lundi", es: "Lunes", hint: "Día de la semana", audio: "lundi.m4a" },
      { fr: "Il pleut", es: "Llueve", hint: "Meteorología", audio: "il-pleut.m4a" },
      { fr: "Il fait chaud", es: "Hace calor", hint: "Meteorología / sensación", audio: "il-fait-chaud.m4a" },
      { fr: "Mon cahier", es: "Mi cuaderno", hint: "Objeto de aula y posesivo", audio: "mon-cahier.m4a" },
      { fr: "Votre adresse", es: "Su dirección", hint: "Dato personal básico", audio: "votre-adresse.m4a" },
      { fr: "Un kilo de pommes", es: "Un kilo de manzanas", hint: "Cantidad y compra", audio: "un-kilo-de-pommes.m4a" },
      { fr: "Je ne comprends pas", es: "No entiendo", hint: "Pedir apoyo", audio: "je-ne-comprends-pas.m4a" },
      { fr: "Pouvez-vous répéter, s'il vous plaît ?", es: "¿Puede repetir, por favor?", hint: "Pedir repetición", audio: "pouvez-vous-repeter.m4a" },
      { fr: "Pouvez-vous parler plus lentement ?", es: "¿Puede hablar más despacio?", hint: "Aclaración", audio: "parler-plus-lentement.m4a" },
      { fr: "Pouvez-vous m'aider ?", es: "¿Puede ayudarme?", hint: "Solicitar ayuda", audio: "pouvez-vous-maider.m4a" },
      { fr: "J'ai un entretien", es: "Tengo una entrevista", hint: "Trabajo y gestión", audio: "jai-un-entretien.m4a" },
      { fr: "Je suis disponible demain", es: "Estoy disponible mañana", hint: "Cita y disponibilidad", audio: "je-suis-disponible-demain.m4a" },
      { fr: "C'est bien cette adresse ?", es: "¿Es correcta esta dirección?", hint: "Confirmar información", audio: "cest-bien-cette-adresse.m4a" },
      { fr: "Je voudrais un café", es: "Quisiera un café", hint: "Petición concreta", audio: "je-voudrais-un-cafe.m4a" },
      { fr: "Un billet, s'il vous plaît", es: "Un billete, por favor", hint: "Transporte", audio: "un-billet-sil-vous-plait.m4a" },
      { fr: "Je vais à la pharmacie", es: "Voy a la farmacia", hint: "Ciudad y necesidad cotidiana", audio: "je-vais-a-la-pharmacie.m4a" },
      { fr: "La salle est à gauche", es: "La sala está a la izquierda", hint: "Centro de formación", audio: "la-salle-est-a-gauche.m4a" },
      { fr: "Je dois partir", es: "Tengo que irme", hint: "Situación cotidiana", audio: "je-dois-partir.m4a" }
    ];
