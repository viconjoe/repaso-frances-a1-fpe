...
Estado actual del recurso: **v2.8**. La ampliación pedagógica incorpora más vocabulario, situaciones, notas de gramática funcional, comprensión lectora A1, comprensión auditiva con cinco audios locales propios del autor, expresión oral guiada con grabación local opcional y temporal, autoevaluación final orientativa, rúbrica docente/documental, mejoras UX de acceso y claridad inicial, y una fase de variación comunicativa progresiva, sin cargar datos externos ni añadir servicios.
...
- incluir práctica oral guiada con grabación local opcional solo si se mantiene aviso de privacidad, borrado local y ausencia de envío de audio;
- mantener la autoevaluación final como orientación local no oficial;
- usar rúbricas solo como apoyo docente/documental, no como calificación oficial;
