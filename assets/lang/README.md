...
Estado actual del recurso: **v2.3.1**. La ampliación pedagógica incorpora más vocabulario, situaciones, notas de gramática funcional, comprensión lectora A1 y comprensión auditiva con cinco audios locales propios del autor, sin cargar datos externos ni añadir servicios.
