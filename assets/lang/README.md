...
Estado actual del recurso: **v2.3.2**. La ampliación pedagógica incorpora más vocabulario, situaciones, notas de gramática funcional, comprensión lectora A1, comprensión auditiva con cinco audios locales propios del autor y una mejora UX de acceso inicial, sin cargar datos externos ni añadir servicios.
