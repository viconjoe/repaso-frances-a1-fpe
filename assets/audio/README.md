...
Estado del recurso: v2.6. La comprensión auditiva A1 incorpora cinco audios locales propios del autor, la expresión oral guiada se realiza sin grabación y la autoevaluación final es orientativa. El criterio no cambia: solo se contemplan audios locales incluidos como archivos estáticos, sin grabar al alumnado.
