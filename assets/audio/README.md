...
Estado del recurso: v1.5. La fase de capturas y demo no cambia el criterio de audio: solo se contemplan audios locales propios del autor, incluidos como archivos estáticos.
