...
Estado del recurso: v2.7. La comprensión auditiva A1 incorpora cinco audios locales propios del autor, la expresión oral guiada se realiza sin grabación, la autoevaluación final es orientativa y la rúbrica docente/documental no requiere audio ni recogida de datos. El criterio no cambia: solo se contemplan audios locales incluidos como archivos estáticos, sin grabar al alumnado.
