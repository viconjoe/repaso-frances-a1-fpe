...
Estado del recurso: v2.0. La fase de producto demostrativo no cambia el criterio de audio: solo se contemplan audios locales propios del autor, incluidos como archivos estáticos.
